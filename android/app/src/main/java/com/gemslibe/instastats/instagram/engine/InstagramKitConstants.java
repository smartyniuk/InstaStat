...
public class InstagramKitConstants {
    ...
    public static String kInstagramAppClientIdConfigurationKey = "com.gemslibe.instastats.instagram.InstagramAppClientId";
    public static String kInstagramAppRedirectURLConfigurationKey = "com.gemslibe.instastats.instagram.InstagramAppRedirectURL";
