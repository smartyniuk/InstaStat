package com.gemslibe.instastats.instagram.objects;
...
public class IGMedia implements Serializable {
    ...
    /**
     * @param usersInPhoto The users_in_photo
     */
    ...
    /**
     * @param userHasLiked The user_has_liked
     */
